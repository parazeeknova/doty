...
Scope {
  ...
  property var apps: []
  property var diagnostics: {"pipewire_version": "Running", "sample_rate": "48kHz", "output_desc": "Default"}
                  ...
                  Row {
                    ...
                    Rectangle {
                      ...
                      Rectangle {
                        ...
                        width: (root.media && root.media.length > 0) ? (parent.width * Math.min(1.0, root.media.position / root.media.length)) : 0
                        color: "#d5c4a1"
                      }
            ...
            Column {
              ...
              Item {
                ...
                Row {
                  ...
                  property double currentVal: root.defaultSink ? root.defaultSink.volume / 100.0 : 0.0
            ...
            Column {
              ...
              Item {
                ...
                Row {
                  ...
                  property int totalBlocks: 15
                  property double currentVal: root.defaultSource ? root.defaultSource.volume / 100.0 : 0.0
                  ...
                  delegate: Column {
                    ...
                    Item {
                      ...
                      Row {
                        ...
                        property int totalBlocks: 15
                        property double currentVal: modelData.volume / 100.0
                ...
                Repeater {
                  ...
                  delegate: Rectangle {
                    ...
                    Text {
                      ...
                      opacity: root.defaultSink && root.defaultSink.name === modelData.name ? 1.0 : 0.7
                      font.family: "FiraCode Nerd Font"
                      font.pixelSize: 9
                      renderType: Text.NativeRendering
                    }
                ...
                Repeater {
                  ...
                  delegate: Rectangle {
                    ...
                    Text {
                      ...
                      opacity: root.defaultSource && root.defaultSource.name === modelData.name ? 1.0 : 0.7
                      font.family: "FiraCode Nerd Font"
                      font.pixelSize: 9
                      renderType: Text.NativeRendering
                    }
