  ...
  Timer {
    ...
    onTriggered: {
      ...
      if (pendingKbdVol !== -1) {
        ...
        var val = Math.round((pendingKbdVol / 100.0) * 3.0);
        if (root.kbdDevice !== "") {
          Quickshell.execDetached(["brightnessctl", "-d", root.kbdDevice, "set", String(val)]);
          // Trigger OSD
          var pct = Math.round((val / 3.0) * 100);
            ...
            Column {
              ...
              Item {
                ...
                Row {
                  ...
                  property double currentVal: root.screenBrightness / 100.0
                  ...
                  Repeater {
                    ...
                    delegate: Rectangle {
                      ...
                      color: (index < Math.round(screenSliderBlocks.currentVal * screenSliderBlocks.totalBlocks)) ? "#d5c4a1" : "#3c3836"
                    }
                  }
                }
            ...
            Column {
              ...
              Item {
                ...
                Row {
                  ...
                  property int totalBlocks: 15
                  property double currentVal: root.kbdBrightness / 100.0
                  ...
                  Repeater {
                    ...
                    delegate: Rectangle {
                      ...
                      color: (index < Math.round(kbdSliderBlocks.currentVal * kbdSliderBlocks.totalBlocks)) ? "#d5c4a1" : "#3c3836"
                    }
                  }
                }
                ...
                MouseArea {
                  ...
                  function updateVol(mouseX) {
                    ...
                    if (pct < 16) pct = 0;
                    else if (pct < 50) pct = 33;
                    else if (pct < 83) pct = 67;
                    else pct = 100;
            ...
            Column {
              ...
              Row {
                ...
                Rectangle {
                  width: 106
                  height: 16
                  color: (root.sunsetState.toLowerCase() === "auto") ? "#d5c4a1" : "#3c3836"
                  radius: 0

                  Text {
                    anchors.centerIn: parent
                    text: "Auto"
                    color: (root.sunsetState.toLowerCase() === "auto") ? "#1d2021" : "#d5c4a1"
                    font.family: "FiraCode Nerd Font"
                    font.pixelSize: 8
                    font.bold: true
                    renderType: Text.NativeRendering
                ...
                Rectangle {
                  width: 106
                  height: 16
                  color: (root.sunsetState.toLowerCase() === "off") ? "#d5c4a1" : "#3c3836"
                  radius: 0

                  Text {
                    anchors.centerIn: parent
                    text: "Off"
                    color: (root.sunsetState.toLowerCase() === "off") ? "#1d2021" : "#d5c4a1"
                    font.family: "FiraCode Nerd Font"
                    font.pixelSize: 8
                    font.bold: true
                    renderType: Text.NativeRendering
              ...
              Item {
                ...
                Row {
                  ...
                  property double currentVal: (parsedTemp - 2800) / (6500.0 - 2800.0)
                  ...
                  Repeater {
                    ...
                    delegate: Rectangle {
                      ...
                      color: (index < Math.round(tempSliderBlocks.currentVal * tempSliderBlocks.totalBlocks)) ? "#d5c4a1" : "#3c3836"
                    }
                  }
                }
                ...
                MouseArea {
                  ...
                  function updateTemp(mouseX) {
                    ...
                    target = Math.round(target / 50.0) * 50;
            ...
            Row {
              ...
              Text {
                ...
                MouseArea {
                  anchors.fill: parent
                  hoverEnabled: true
                  onEntered: caffeineToggle.color = "#ebdbb2"
                  onExited: caffeineToggle.color = "#d5c4a1"
                  onClicked: {
