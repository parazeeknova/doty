...
Scope {
  ...
  Process {
    ...
    command: {
      ...
      if (root.pendingScan) cmd.push("--scan");
      return cmd;
    }
    running: false
        ...
        Rectangle {
          ...
          Column {
            ...
            Row {
              ...
              Column {
                ...
                Text {
                  text: {
                    ...
                    if (root.btEnabled === false) return "Disabled";
                    var connected = root.devices.filter(function(d) { return d.connected; });
                    if (connected.length === 0) return "No devices connected";
                    return connected.map(function(d) { return d.name; }).join(", ");
                  }
                  color: "#d5c4a1"
                  opacity: 0.6
                  font.family: "FiraCode Nerd Font"
              ...
              Text {
                ...
                MouseArea {
                  ...
                  onClicked: {
                    if (checkStatusProc.running) return;
                    root.scanning = true;
            ...
            Column {
              width: parent.width
              spacing: 3
              visible: !root.loading && root.btEnabled && root.devices.filter(function(d) { return d.connected; }).length > 0
              ...
              Column {
                ...
                Repeater {
                  model: root.devices.filter(function(d) { return d.connected; })
                  delegate: Column {
                    width: parent.width
                    spacing: 2
                    ...
                    Rectangle {
                      ...
                      Row {
                        ...
                        Text {
                          text: {
                            var icon = "󰋋";
                            if (modelData.device_type === "keyboard") icon = "󰌌";
                            else if (modelData.device_type === "mouse") icon = "󰍽";
                            else if (modelData.device_type === "controller") icon = "󰊴";
              ...
              Text {
                ...
                font.pixelSize: 8
                renderType: Text.NativeRendering
                visible: root.devices.filter(function(d) { return d.connected; }).length === 0
              }
            }
            ...
            Column {
              width: parent.width
              spacing: 3
              visible: !root.loading && root.btEnabled && root.devices.filter(function(d) { return d.paired && !d.connected; }).length > 0
              ...
              Column {
                ...
                Repeater {
                  model: root.devices.filter(function(d) { return d.paired && !d.connected; })
                  delegate: Column {
                    width: parent.width
                    spacing: 2
              ...
              Text {
                ...
                font.pixelSize: 8
                renderType: Text.NativeRendering
                visible: root.devices.filter(function(d) { return d.paired && !d.connected; }).length === 0
              }
            }
            ...
            Column {
              ...
              Text {
                ...
                font.pixelSize: 8
                renderType: Text.NativeRendering
                visible: root.devices.filter(function(d) { return !d.paired; }).length === 0
              }
            }
