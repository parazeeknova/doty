...
Scope {
  ...
  property double health: 100.0
  property double powerDraw: 0.0
            ...
            Row {
              ...
              Rectangle {
                ...
                Text {
                  ...
                  opacity: root.activeProfile === "Quiet" ? 1.0 : 0.7
                  font.family: "FiraCode Nerd Font"
                  font.pixelSize: 9
                  renderType: Text.NativeRendering
                }
              ...
              Rectangle {
                ...
                Text {
                  ...
                  opacity: root.activeProfile === "Balanced" ? 1.0 : 0.7
                  font.family: "FiraCode Nerd Font"
                  font.pixelSize: 9
                  renderType: Text.NativeRendering
                }
              ...
              Rectangle {
                ...
                Text {
                  ...
                  opacity: root.activeProfile === "Performance" ? 1.0 : 0.7
                  font.family: "FiraCode Nerd Font"
                  font.pixelSize: 9
                  renderType: Text.NativeRendering
                }
