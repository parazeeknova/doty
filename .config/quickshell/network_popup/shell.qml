...
Scope {
  ...
  property var details: ({"ip_address": "", "gateway": "", "dns": "", "subnet": "", "security": "", "bssid": ""})
          ...
          Column {
            ...
            Column {
              ...
              Column {
                ...
                Text { text: "  IP: " + root.details.ip_address; color: "#d5c4a1"; font.family: "FiraCode Nerd Font"; font.pixelSize: 8; renderType: Text.NativeRendering }
                Text { text: "  Gateway: " + root.details.gateway; color: "#d5c4a1"; font.family: "FiraCode Nerd Font"; font.pixelSize: 8; renderType: Text.NativeRendering }
                Text { text: "  Subnet: " + root.details.subnet; color: "#d5c4a1"; font.family: "FiraCode Nerd Font"; font.pixelSize: 8; renderType: Text.NativeRendering }
                Text { text: "  DNS: " + root.details.dns; color: "#d5c4a1"; font.family: "FiraCode Nerd Font"; font.pixelSize: 8; renderType: Text.NativeRendering }
                Text { text: "  BSSID: " + root.details.bssid; color: "#d5c4a1"; font.family: "FiraCode Nerd Font"; font.pixelSize: 8; renderType: Text.NativeRendering }
                Text { text: "  Security: " + root.details.security; color: "#d5c4a1"; font.family: "FiraCode Nerd Font"; font.pixelSize: 8; renderType: Text.NativeRendering }
              }
                  ...
                  delegate: Column {
                    ...
                    Rectangle {
                      ...
                      Text {
                        ...
                        text: {
                          var activeLimit = Math.round(modelData.signal / 20.0);
