...
-- Editors
hl.bind(mainMod .. " + semicolon", hl.dsp.exec_cmd("hyprctl clients | grep -iq 'class: .*code-insiders' && hyprctl dispatch 'hl.dsp.focus({ workspace = 2 })' || (uwsm app -- code-insiders && hyprctl dispatch 'hl.dsp.focus({ workspace = 2 })')"))
...
hl.bind(mainMod .. " + SHIFT + G", hl.dsp
