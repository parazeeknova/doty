      ...
      environment.systemPackages = with pkgs; [
        ...
        (stdenv.mkDerivation rec {
          ...
          src = fetchurl {
            ...
            sha256 = "0nbphcickv20a9hkj77diarnlp63d4g8znk9qq2izbak3g39bfks";
          };
          ...
          installPhase = ''
            ...
            find $out/share/qoder -name "*musl*" -exec rm -rf {} + || true

            chmod +x $out/share/qoder/qoder
            ...
            mkdir -p $out/share/applications
            cat > $out/share/applications/qoder.desktop <<EOF
            [Desktop Entry]
            Name=Qoder
            Exec=qoder %F
            Terminal=false
