...
hl.on("hyprland.start", function()
	...
	-- Pre-warm the notification popup so SUPER+N opens instantly (resident process starts hidden)
	hl.exec_cmd("sh -c 'sleep 4; env QS_LAYOUT_MODE=tiling quickshell --config notif_popup >/dev/null 2>&1 &'")
