...
in
{
  ...
  flake.nixosModules.parazeeknovaKitty = { config, pkgs, lib, ... }: {
    ...
    in
    {
      ...
      programs.kitty = {
        ...
        keybindings = {
          ...
          "ctrl+shift+f" = "launch --location=hsplit --allow-remote-control kitty +kitten search.py @active-kitty-window-id";
